...
import { getEntryExtraArgs } from '../../business/EnhancedToDoList';

/**
 * Intérêt pédagogique : utilisation des state hook.
 */
const TdlEditingElement = ({
    ...
    <>
      <Form onSubmit={handleSubmit}>
        <Form.Row className="my-1">
          <Col>
            <Form.Label htmlFor="contentNewEntry" srOnly>
              Contenu
            </Form.Label>
            <Form.Control
              required
          ...
          <Col>
            <Form.Label htmlFor="dueDateNewEntry" srOnly>
              Name
            </Form.Label>
            <Form.Control
              type="date"
        ...
        {canHaveExtraArgs && (
          <>
            {extraArgs.map((ea, idx) => (
              ...
              >
                <Col>
                  <Form.Label htmlFor={`extraArg${idx}NameNewEntry`} srOnly>
                    Nom de propriété
                  </Form.Label>
                  <Form.Control
                    required
                ...
                <Col>
                  <Form.Label htmlFor={`extraArg${idx}ValueNewEntry`} srOnly>
                    Valeur de propriété
                  </Form.Label>
                  <Form.Control
                    required
