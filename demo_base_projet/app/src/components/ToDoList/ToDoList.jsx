 ...
 */
const ToDoListInt = ({
  mainstore, errorstore, listName, canHaveExtraArgs,
}) => {
...
ToDoListInt.defaultProps = {
  canHaveExtraArgs: false,
};

ToDoListInt.propTypes = {
...
const ToDoList = inject('mainstore', 'errorstore')(observer(ToDoListInt));
