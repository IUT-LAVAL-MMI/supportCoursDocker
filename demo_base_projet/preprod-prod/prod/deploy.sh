...
#git clone -b master https://github.com/IUT-LAVAL-MMI/2122-LPDIWA-PROJET-G1.git
...
echo "Testez l'url http://la-diwa-01.univ-lemans.fr. Il faut attendre au moins 1 minute 30. Si cela ne fonctionne toujours pas analysez les logs des conteneurs."
...
#    http_response=$(curl -s -o response.txt -w "%{http_code}" http://site.groupe1.iwave-oic.fr/)
